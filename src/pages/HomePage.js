...
function HomePage() {
  return (
    <Box sx={{ height: '100vh', bgcolor: PAGE_COLOR }}>
      <Box pt={30} />
      ...
      <Container sx={{ width: 600, ml: '50%' }}>
        ...
        <Box sx={{
          ...
          with civic engagement in my community. Here's a glimpse into the journey
          of my career! Allow me to take you on a journey through my career!
        </Box>
      </Container>
